...
///
/// Returns a future containing the result of the entry point method.
Future<Object?> loadModuleFromBytes(Uri uri, Uint8List bytes) =>
    internal.loadDynamicModule(bytes: bytes).then((result) {
      _loadedModules.add(uri);
      return result;
    });

final Set<Uri> _loadedModules = {};

bool isModuleLoaded(Uri uri) => _loadedModules.contains(uri);
